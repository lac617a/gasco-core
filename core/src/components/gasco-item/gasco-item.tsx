...
import { printGascoError } from '../../utils/logging';
import { createColorClasses, hostContext } from '../../utils/theme';
import type { InputChangeEventDetail } from '../gasco-input/gasco-input-interface';

import type { CounterFormatter } from './gasco-item-interface';
...
@Component({
  tag: 'gasco-item',
  styleUrl: 'gasco-item.md.scss',
  shadow: {
    delegatesFocus: true,
  },
})
export class GascoItem implements ComponentInterface, AnchorInterface, ButtonInterface {
  private labelColorStyles = {};
  private itemStyles = new Map<string, CssClassMap>();
  private clickListener?: (ev: Event) => void;

  @Element() el!: HTMLGascoItemElement;
  ...
  private updateCounterOutput(inputEl: HTMLGascoInputElement) {
    ...
    if (counter && !this.multipleInputs && inputEl?.maxlength !== undefined) {
      ...
      if (counterFormatter === undefined) {
        ...
        try {
          ...
          printGascoError('Exception in provided `counterFormatter`.', e);
      ...
      <Host
        ...
        class={{
          ...
          ...createColorClasses(this.color, {
            ...
            'gasco-focusable': this.focusable,
