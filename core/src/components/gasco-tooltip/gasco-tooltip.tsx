...
import { configureDismissInteraction, configureKeyboardInteraction, configureTriggerInteraction } from './gasco-tooltip-utils';
...
@Component({
  tag: 'gasco-tooltip',
  styleUrl: 'gasco-tooltip.md.scss',
  shadow: true,
})
export class GascoTooltip implements ComponentInterface, PopoverInterface {
  private usersElement?: HTMLElement;
  private triggerEl?: HTMLElement | null;
  private parentPopover: HTMLGascoTooltipElement | null = null;
  ...
  @Element() el!: HTMLGascoTooltipElement;
   ...
   */
  @Event({ eventName: 'gascoTooltipDidPresent' }) didPresent!: EventEmitter<void>;

  /**
   * Emitted before the popover has presented.
   */
  @Event({ eventName: 'gascoTooltipWillPresent' }) willPresent!: EventEmitter<void>;

  /**
   * Emitted before the popover has dismissed.
   */
  @Event({ eventName: 'gascoTooltipWillDismiss' }) willDismiss!: EventEmitter<OverlayEventDetail>;

  /**
   * Emitted after the popover has dismissed.
   */
  @Event({ eventName: 'gascoTooltipDidDismiss' }) didDismiss!: EventEmitter<OverlayEventDetail>;

  /**
   * Emitted after the popover has presented.
   * Shorthand for gascoTooltipWillDismiss.
   */
  @Event({ eventName: 'didPresent' }) didPresentShorthand!: EventEmitter<void>;

  /**
   * Emitted before the popover has presented.
   * Shorthand for gascoTooltipWillPresent.
   */
  ...
  /**
   * Emitted after the popover has dismissed.
   * Shorthand for gascoTooltipDidDismiss.
   */
  ...
  componentWillLoad() {
     ...
     */
    this.popoverId = this.el.hasAttribute('id') ? this.el.getAttribute('id')! : `gasco-tooltip-${this.popoverIndex}`;

    this.parentPopover = this.el.closest(`gasco-tooltip:not(#${this.popoverId})`) as HTMLGascoTooltipElement | null;
  ...
  componentDidLoad() {
    ...
    if (parentPopover) {
      addEventListener(parentPopover, 'gascoTooltipWillDismiss', () => {
   ...
   */
  @Method()
  async getParentPopover(): Promise<HTMLGascoTooltipElement | null> {
  ...
  onDidDismiss<T = any>(): Promise<OverlayEventDetail<T>> {
    return eventMethod(this.el, 'gascoTooltipDidDismiss');
  }
  ...
  onWillDismiss<T = any>(): Promise<OverlayEventDetail<T>> {
    return eventMethod(this.el, 'gascoTooltipWillDismiss');
  }
...
const LIFECYCLE_MAP: any = {
  gascoTooltipDidPresent: 'gascoViewDidEnter',
  gascoTooltipWillPresent: 'gascoViewWillEnter',
  gascoTooltipWillDismiss: 'gascoViewWillLeave',
  gascoTooltipDidDismiss: 'gascoViewDidLeave',
};
