...
export const createSheetGesture = (
  baseEl: HTMLGascoModalElement,
  backdropEl: HTMLGascoBackdropElement,
  ...
  const contentEl = baseEl.querySelector('gasco-content');
  ...
  const enableBackdrop = () => {
     ...
     * the sheet.
     */
    baseEl.classList.remove('gasco-disable-focus-trap');
  };
  ...
  const disableBackdrop = () => {
     ...
     */
    baseEl.classList.add('gasco-disable-focus-trap');
  };
  ...
  if (wrapperAnimation && backdropAnimation) {
     ...
     * to remove pointer-events from gasco-modal as a whole.
     * gasco-backdrop and .modal-wrapper always have pointer-events: auto
  ...
  const canStart = (detail: GestureDetail) => {
     ...
     */
    const content = (detail.event.target! as HTMLElement).closest('gasco-content');
