...
import { findClosestGascoContent, disableContentScrollY, resetContentScrollY } from '../../utils/content';
...
import type { PinFormatter } from './gasco-range-interface';
...
@Component({
  tag: 'gasco-range',
  styleUrl: 'gasco-range.md.scss',
  shadow: true,
})
export class GascoRange implements ComponentInterface {
  ...
  @Element() el!: HTMLGascoRangeElement;
   ...
   */
  @Event() gascoChange!: EventEmitter<RangeChangeEventDetail>;
   ...
   */
  @Event() gascoKnobMoveStart!: EventEmitter<RangeKnobMoveStartEventDetail>;

  /**
   * Emitted when the user finishes moving the range knob, whether through
   * mouse drag, touch gesture, or keyboard interaction.
   */
  @Event() gascoKnobMoveEnd!: EventEmitter<RangeKnobMoveEndEventDetail>;
  ...
  componentWillLoad() {
     ...
     */
    this.rangeId = this.el.hasAttribute('id') ? this.el.getAttribute('id')! : `gasco-r-${rangeIds++}`;
  ...
  connectedCallback() {
    ...
    this.contentEl = findClosestGascoContent(this.el);
  }
  ...
  private handleKeyboard = (knob: KnobName, isIncrease: boolean) => {
    ...
    this.gascoKnobMoveStart.emit({ value: ensureValueInBounds(this.value) });
    this.updateValue();
    this.gascoKnobMoveEnd.emit({ value: ensureValueInBounds(this.value) });
  };
  ...
  private onStart(detail: GestureDetail) {
    ...
    this.gascoKnobMoveStart.emit({ value: this.ensureValueInBounds(this.value) });
  }
  ...
  private onEnd(detail: GestureDetail) {
    ...
    this.gascoKnobMoveEnd.emit({ value: this.ensureValueInBounds(this.value) });
  }
