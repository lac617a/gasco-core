...
@Component({
  tag: 'gasco-label',
  styleUrl: 'gasco-label.md.scss',
  scoped: true,
})
export class GascoLabel implements ComponentInterface {
  ...
  componentWillLoad() {
    this.inRange = !!this.el.closest('gasco-range');
    ...
    return (
      <Host
        class={createColorClasses(this.color, {
          'in-item-color': hostContext('gasco-item.gasco-color', this.el),
          [`label-${position}`]: position !== undefined,
