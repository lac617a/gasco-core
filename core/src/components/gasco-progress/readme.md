...
| `progress` | `progress` | If true, reverse the progress bar direction.                                                                                                                                                | `"circle" \| "line"`                                                                                                                             | `'line'`        |
| `reversed` | `reversed` | If true, reverse the progress bar direction.                                                                                                                                                | `boolean`                                                                                                                                        | `false`         |
| `size`     | `size`     | The Progress size only for circle.                                                                                                                                                          | `"default" \| "large" \| "small"`                                                                                                                | `undefined`     |
