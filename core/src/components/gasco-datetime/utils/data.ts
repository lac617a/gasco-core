import type { DatetimeParts } from '../gasco-datetime-interface';
...
export const getToday = () => {
  /**
   * gasco-datetime intentionally does not
 ...
 * or "T".
 */
export const getDaysOfWeek = (locale: string, firstDayOfWeek = 0) => {
  /**
   * Nov 1st, 2020 starts on a Sunday.
   * gasco-datetime assumes weeks start on Sunday,
