...
export const configureDismissInteraction = (
  ...
  popoverEl: HTMLGascoPopoverElement,
  parentPopoverEl: HTMLGascoPopoverElement
) => {
      ...
      dismissCallbacks = [
        {
          ...
          callback: (ev: MouseEvent) => {
            ...
            const closestTrigger = target.closest('[data-gasco-popover-trigger]');
...
export const configureTriggerInteraction = (
      ...
      triggerCallbacks = [
        ...
        },
        {
          ...
          callback: (ev: MouseEvent) => {
            ...
            if (target.closest('gasco-popover') !== popoverEl) {
              popoverEl.dismiss(undefined, undefined, false);
            }
          },
        },
  ...
  triggerEl.setAttribute('data-gasco-popover-trigger', 'true');

  return () => {
    triggerCallbacks.forEach(({ eventName, callback }) => triggerEl.removeEventListener(eventName, callback));
    triggerEl.removeAttribute('data-gasco-popover-trigger');
  };
};
 ...
 */
export const isTriggerElement = (el: HTMLElement) => el.hasAttribute('data-gasco-popover-trigger');

export const configureKeyboardInteraction = (popoverEl: HTMLGascoPopoverElement) => {
  const callback = async (ev: KeyboardEvent) => {
     ...
     */
    if (targetTagName !== 'GASCO-POPOVER' && targetTagName !== 'GASCO-ITEM') {
      return;
    }
    /**
